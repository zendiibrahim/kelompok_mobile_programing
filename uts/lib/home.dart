...
class HomePage extends State<Home> {
  ...
  void count(){
    ...
    //total item di keranjang belanja
    // for (var i = 0; i < 3; i++) {
    //   var tot = makanan[0][i];
    //   _total+=tot;
    // }
...
Container(
        ...
        //history menu
          ...
          (
            ...
            if(hist[0]==0 && hist[1]==0 && hist[2]==0 && hist[3]==0 && hist[4]==0 && hist[5]==0 && hist[6]==0 && hist[7]==0 && hist[8]==0
            && hist[9]==0 && hist[10]==0 && hist[11]==0 && hist[12]==0 && hist[13]==0 && hist[14]==0)
              Container(
                  child: Align(
                    alignment: Alignment.center,
                    child: Text(
